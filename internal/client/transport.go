...
const (
	...
	betaHeaderValue  = "agents=v1"
	userAgentName    = "terraform-provider-openaiagents"
	productionHost   = "api.openai.com"
	adminKeyEnvName  = "OPENAI_ADMIN_KEY"
	apiKeyEnvName    = "OPENAI_API_KEY"
	orgEnvName       = "OPENAI_ORG_ID"
	orgAltEnvName    = "OPENAI_ORGANIZATION"
	projectEnvName   = "OPENAI_PROJECT"
...
func newCredentialAudienceHTTPClient(endpoint *url.URL, timeout time.Duration) *http.Client {
	if timeout <= 0 {
...
func isProductionHost(host string) bool {
	return strings.EqualFold(host, productionHost)
}
